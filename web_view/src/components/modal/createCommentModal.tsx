...
export function CreateCommentModal({ issueId }: { issueId: number }) {
	...
	return (
		<>
			{name !== "" && (
				<button
					className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 w-full bg-green-500 text-white rounded-lg my-4"
					...
					<div className="w-1/2 max-w-[50rem] rounded-lg bg-white p-6 shadow-lg">
						<div className="space-y-4">
							<div className="text-center">
								<h2 className="text-2xl font-bold">New Comment</h2>
								<p className="text-gray-500">새 코멘트를 생성합니다.</p>
							</div>
