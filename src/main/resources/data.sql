...
-- Issues'
INSERT INTO issue (title, create_date, update_date, due_date, content, project_id, reporter_id, status, priority) VALUES ('Issue 1', '2024-05-18T12:00:00', '2024-05-18T12:00:00', '2024-05-25T12:00:00', 'This is issue 1', 1, 1, 'FIXED', 'MAJOR');
INSERT INTO issue (title, create_date, update_date, due_date, content, project_id, reporter_id, status, priority) VALUES ('Issue 1-1', '2024-05-18T12:00:00', '2024-05-18T12:00:00', '2024-05-25T12:00:00', 'is Hello', 1, 5, 'FIXED', 'MAJOR');
INSERT INTO issue (title, create_date, update_date, due_date, content, project_id, reporter_id, status, priority) VALUES ('Issue 2', '2024-05-25T13:00:00', '2024-05-25T13:00:00', '2024-06-01T13:00:00', 'This is issue 2', 1, 2, 'ASSIGNED', 'CRITICAL');
...
UPDATE issue SET fixer_id = 4 WHERE id = 2;
